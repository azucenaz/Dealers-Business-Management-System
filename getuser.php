        ...
        <form parsley-validate id="editusers" name="editusers" class="form-horizontal">
          <fieldset>      
                        ...
                        <option value="Mandaue" <?php if($row['branchid'] == 'Mandaue'){ echo 'selected';}else{echo ''; }?>>Mandaue</option>
                                                <option value="Danao" <?php if($row['branchid'] == 'Danao'){ echo 'selected';}else{echo ''; }?>>Danao</option>
                                                <option value="Lapu-Lapu" <?php if($row['branchid'] == 'Lapu-Lapu'){ echo 'selected';}else{echo ''; }?>>Lapu-Lapu</option>
                                                <option value="Lahug" <?php if($row['branchid'] == 'Lahug'){ echo 'selected';}else{echo ''; }?>>Lahug</option>
