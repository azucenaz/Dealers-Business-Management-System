              ...
              <div class="col-lg-12">
                <div class="widget-container fluid-height">
                  ...
                  <div class="tab-content padded" >
                      ...
                      <h3>
                        Special Stocks<div class="pull-right"><a href="#" class="fa fa-undo" style="font-size:20px;" id="backtostocks"></a></div>
                      </h3>
                      <p>
                       ...
                       <input type="text" class="form-control" placeholder="Enter Color" id="color" name="color">
                          ...
                          <div class="col-md-4">
                          <input  type="number" step="0.01" min="0" class="form-control" name="price" id="price" class="form-control" placeholder="Enter Price" required> 
                          </div>
                          <div class="col-md-4">
                         <input  type="number" step="0.01" min="0" class="form-control" name="downpayment" id="downpayment" class="form-control" placeholder="Enter Downpayment" required> 
                          </div>
             ...
             $.ajax(
                    {
                        ...
                        type: "POST",
                        url: "execute/specialstocks.php",
                        data: "category_name="+category_name+"&model_name="+model_name+"&chassis="+chassis+"&engine_number="+engine_number+"&color="+color+"&branchname="+branchname+"&price="+price+"&downpayment="+downpayment+ "&SUBMIT=",
                        cache: false,
                        success: function (data) 
                        {
